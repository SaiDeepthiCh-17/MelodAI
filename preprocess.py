...
m21.environment.set("musicxmlPath", r"C:\Program Files\MuseScore 4\bin\MuseScore4.exe")
KERN_DATASET_PATH = r"C:\Users\DELL\Desktop\MelodAI-Project\Data pre-processing\essen\europa\deutschl\erk"
SAVE_DIR=r"C:\Users\DELL\Desktop\MelodAI-Project\Data pre-processing\dataset"
...
def generate_training_sequences(sequence_length):
    ...
    int_songs=int_songs[:60000] # for testing purposes, we will use only the first 60k symbols in the dataset. Remove this line for training on the whole dataset
    ...
    vocabulary_size = max(int_songs)+1
